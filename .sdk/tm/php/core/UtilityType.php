...
// QuoteRetrieval SDK utility type

class QuoteRetrievalUtility
{
    ...
    public static function copy(QuoteRetrievalUtility $src): QuoteRetrievalUtility
    {
        $u = new QuoteRetrievalUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
