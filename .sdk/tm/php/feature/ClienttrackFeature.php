...
// QuoteRetrieval SDK clienttrack feature
...
class QuoteRetrievalClienttrackFeature extends QuoteRetrievalBaseFeature
{
    ...
    public function PostConstruct(QuoteRetrievalContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'QuoteRetrieval-SDK';
