...
// QuoteRetrieval SDK debug feature
...
class QuoteRetrievalDebugFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _finish(QuoteRetrievalContext $ctx, bool $ok): void
    {
