...
// QuoteRetrieval SDK netsim feature
...
class QuoteRetrievalNetsimFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _simulate(QuoteRetrievalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(QuoteRetrievalContext $ctx, array $applied): void
    {
        $client = $this->client;
