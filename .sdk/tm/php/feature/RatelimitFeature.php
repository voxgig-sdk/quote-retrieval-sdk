...
// QuoteRetrieval SDK ratelimit feature
...
class QuoteRetrievalRatelimitFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _acquire(QuoteRetrievalContext $ctx): void
    {
    ...
    private function _track(QuoteRetrievalContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
