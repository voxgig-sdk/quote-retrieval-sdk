...
// QuoteRetrieval SDK streaming feature
...
class QuoteRetrievalStreamingFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _iterate(QuoteRetrievalResult $result): \Generator
    {
    ...
    private function _streamable(QuoteRetrievalContext $ctx): bool
    {
