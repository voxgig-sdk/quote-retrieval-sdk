...
// QuoteRetrieval SDK timeout feature
...
class QuoteRetrievalTimeoutFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _with_timeout(QuoteRetrievalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(QuoteRetrievalContext $_ctx, float $ms): void
    {
        $client = $this->client;
