...
// QuoteRetrieval SDK utility: fetcher

class QuoteRetrievalFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; QuoteRetrievalSDK/1.0)';
    ...
    public static function call(QuoteRetrievalContext $ctx, string $fullurl, array $fetchdef): array
    {
