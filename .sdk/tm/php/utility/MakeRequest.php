...
// QuoteRetrieval SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class QuoteRetrievalMakeRequest
{
    public static function call(QuoteRetrievalContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new QuoteRetrievalResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new QuoteRetrievalResponse($fetched);
        } else {
