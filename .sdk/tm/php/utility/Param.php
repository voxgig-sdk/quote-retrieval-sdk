...
// QuoteRetrieval SDK utility: param

require_once __DIR__ . '/../core/Helpers.php';

class QuoteRetrievalParam
{
    public static function call(QuoteRetrievalContext $ctx, mixed $paramdef): mixed
    {
        $point = $ctx->point;
        $spec = $ctx->spec;
        $match_val = $ctx->match;
        ...
        $akey = '';
        if ($point) {
            $alias_map = QuoteRetrievalHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'alias'));
            if ($alias_map) {
