...
class QuoteRetrievalTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = QuoteRetrievalTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = QuoteRetrievalTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = QuoteRetrievalTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
