...
This API retrieves quotes based on a specific ID.

Learn more about Quote Retrieval API at [quoterism.com](https://quoterism.com).
...
| --- | --- | --- |
| **Quote** | The Quote entity (list, load). | `/api/quotes` |
