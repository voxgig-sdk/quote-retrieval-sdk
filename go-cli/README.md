...
AQL-driven CLI and REPL for the QuoteRetrieval SDK. Positional arguments are
...
```sh
go build -o quote-retrieval-cli ./...
```
...
./quote-retrieval-cli load 1 quote
./quote-retrieval-cli load '{id:1}' quote
