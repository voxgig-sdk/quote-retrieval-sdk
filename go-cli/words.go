...
func registerSDKWords(r *eng.Registry, client *sdk.QuoteRetrievalSDK) {
...
func runOp(client *sdk.QuoteRetrievalSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
