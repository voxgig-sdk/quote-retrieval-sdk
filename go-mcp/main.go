// Command QuoteRetrieval-mcp is an MCP server exposing the QuoteRetrieval
// SDK as MCP tools.
//
// Two tools are registered:
//
//	QuoteRetrieval_list  — list records of an entity
//	QuoteRetrieval_load  — load a single record of an entity
//
