...
func registerTools(server *mcp.Server, client *sdk.QuoteRetrievalSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "quote-retrieval_list",
		Description: "List records from QuoteRetrieval. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "quote-retrieval_load",
		Description: "Load a single record from QuoteRetrieval. " +
...
func runOp(client *sdk.QuoteRetrievalSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.QuoteRetrievalSDK, name string) (sdk.QuoteRetrievalEntity, error) {
