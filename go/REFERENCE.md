# QuoteRetrieval Golang SDK Reference

Complete API reference for the QuoteRetrieval Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *QuoteRetrievalSDK`
...
#### `Quote(data map[string]any) QuoteRetrievalEntity`
