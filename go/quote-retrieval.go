...
// instead of `sdk.NewQuoteRetrievalSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *QuoteRetrievalSDK  { return NewQuoteRetrievalSDK(nil) }
func Test() *QuoteRetrievalSDK { return TestSDK(nil, nil) }
