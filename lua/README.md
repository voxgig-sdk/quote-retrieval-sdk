# QuoteRetrieval Lua SDK



The Lua SDK for the QuoteRetrieval API — an entity-oriented client using Lua conventions.
...
GitHub release tag (`lua/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/quote-retrieval-sdk/releases)),
...
```
lua/
├── quote-retrieval_sdk.lua    -- Main SDK module
...
The main module (`quote-retrieval_sdk`) exports the SDK constructor
