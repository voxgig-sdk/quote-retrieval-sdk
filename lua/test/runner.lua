...
function runner.env_override(m)
  local live = runner.getenv("QUOTERETRIEVAL_TEST_LIVE")
  local override = runner.getenv("QUOTERETRIEVAL_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("QUOTERETRIEVAL_TEST_EXPLAIN")
