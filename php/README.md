# QuoteRetrieval PHP SDK



The PHP SDK for the QuoteRetrieval API — an entity-oriented client using PHP conventions.
...
```
php/
├── quoteretrieval_sdk.php          -- Main SDK class
...
The main class (`quoteretrieval_sdk.php`) exports the SDK class
