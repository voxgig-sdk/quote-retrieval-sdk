...
// QuoteRetrieval SDK audit feature
...
class QuoteRetrievalAuditFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _emit(QuoteRetrievalContext $ctx, string $outcome): void
    {
