...
// QuoteRetrieval SDK cache feature
...
class QuoteRetrievalCacheFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _through(QuoteRetrievalContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
