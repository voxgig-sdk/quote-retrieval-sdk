...
// QuoteRetrieval SDK idempotency feature
...
class QuoteRetrievalIdempotencyFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _mutating(QuoteRetrievalContext $ctx): bool
    {
