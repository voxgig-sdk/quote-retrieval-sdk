...
// QuoteRetrieval SDK metrics feature
...
class QuoteRetrievalMetricsFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _record(QuoteRetrievalContext $ctx, bool $ok): void
    {
