...
// QuoteRetrieval SDK paging feature
...
class QuoteRetrievalPagingFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _is_list(QuoteRetrievalContext $ctx): bool
    {
