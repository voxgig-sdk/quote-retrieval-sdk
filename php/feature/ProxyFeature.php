...
// QuoteRetrieval SDK proxy feature
...
class QuoteRetrievalProxyFeature extends QuoteRetrievalBaseFeature
{
    ...
    public function init(QuoteRetrievalContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (QuoteRetrievalContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
