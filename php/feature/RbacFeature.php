...
// QuoteRetrieval SDK rbac feature
...
class QuoteRetrievalRbacFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _required(QuoteRetrievalContext $ctx): ?string
    {
    ...
    private function _reject(QuoteRetrievalContext $ctx, string $required): void
    {
    ...
    private function _track(QuoteRetrievalContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
