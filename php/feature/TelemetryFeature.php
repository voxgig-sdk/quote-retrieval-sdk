...
// QuoteRetrieval SDK telemetry feature
...
class QuoteRetrievalTelemetryFeature extends QuoteRetrievalBaseFeature
{
    ...
    private function _close(QuoteRetrievalContext $ctx, bool $ok): void
    {
