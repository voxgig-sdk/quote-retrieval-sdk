...
// QuoteRetrieval SDK pipeline test
//
...
{
    private static function utility(): QuoteRetrievalUtility
    {
        return new QuoteRetrievalUtility();
    }
    ...
    private static function ctx(array $over = []): QuoteRetrievalContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new QuoteRetrievalContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new QuoteRetrievalOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof QuoteRetrievalError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new QuoteRetrievalOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = QuoteRetrievalMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new QuoteRetrievalOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = QuoteRetrievalMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new QuoteRetrievalOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = QuoteRetrievalMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new QuoteRetrievalSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = QuoteRetrievalMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new QuoteRetrievalResponse([]),
            'result' => new QuoteRetrievalResult([]),
        ]);
        [, $err] = QuoteRetrievalMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new QuoteRetrievalSpec([]),
            'response' => null,
            'result' => new QuoteRetrievalResult([]),
        ]);
        [, $err] = QuoteRetrievalMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new QuoteRetrievalSpec(['step' => 's']),
            'response' => new QuoteRetrievalResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new QuoteRetrievalResult([]),
        ]);
        [, $err] = QuoteRetrievalMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new QuoteRetrievalSpec(['step' => 's']),
            'response' => new QuoteRetrievalResponse(self::resp(200, ['v' => 1])),
            'result' => new QuoteRetrievalResult([]),
        ]);
        [, $err] = QuoteRetrievalMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new QuoteRetrievalSpec(['step' => 's']),
            'response' => new QuoteRetrievalResponse(self::resp(200, ['v' => 2])),
            'result' => new QuoteRetrievalResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        QuoteRetrievalMakeResponse::call($ctx);
    ...
    {
        $preset = new QuoteRetrievalResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new QuoteRetrievalSpec([]),
            'response' => new QuoteRetrievalResponse([]),
            'result' => new QuoteRetrievalResult([]),
        ...
        [$got, $err] = QuoteRetrievalMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new QuoteRetrievalResult([])]);
        [, $err] = QuoteRetrievalMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new QuoteRetrievalSpec([]), 'result' => null]);
        [, $err] = QuoteRetrievalMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new QuoteRetrievalSpec(['step' => 's']),
            'result' => new QuoteRetrievalResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new QuoteRetrievalOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = QuoteRetrievalMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new QuoteRetrievalSpec(['step' => 's']),
            'result' => new QuoteRetrievalResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new QuoteRetrievalOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = QuoteRetrievalMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new QuoteRetrievalResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new QuoteRetrievalSpec([]),
            'result' => new QuoteRetrievalResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = QuoteRetrievalMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = QuoteRetrievalMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new QuoteRetrievalError('boom', 'boom');
        $utility->fetcher = function (QuoteRetrievalContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new QuoteRetrievalSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = QuoteRetrievalMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (QuoteRetrievalContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = QuoteRetrievalMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(QuoteRetrievalResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        QuoteRetrievalMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (QuoteRetrievalContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new QuoteRetrievalSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = QuoteRetrievalMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new QuoteRetrievalResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new QuoteRetrievalSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = QuoteRetrievalMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = QuoteRetrievalMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = QuoteRetrievalMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new QuoteRetrievalResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, QuoteRetrievalDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new QuoteRetrievalResult(['ok' => false])]);
        $this->expectException(QuoteRetrievalError::class);
        QuoteRetrievalDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new QuoteRetrievalResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', QuoteRetrievalMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        QuoteRetrievalMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new QuoteRetrievalBaseFeature();
        $b = new QuoteRetrievalBaseFeature();
        QuoteRetrievalFeatureAdd::call($ctx, $a);
        QuoteRetrievalFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): QuoteRetrievalBaseFeature
    {
        $f = new QuoteRetrievalBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        QuoteRetrievalFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): QuoteRetrievalContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new QuoteRetrievalSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = QuoteRetrievalPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        QuoteRetrievalPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new QuoteRetrievalResponse(['headers' => null]),
            'result' => new QuoteRetrievalResult([]),
        ]);
        QuoteRetrievalResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        QuoteRetrievalResultBody::call($ctx);
