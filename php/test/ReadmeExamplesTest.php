...
// QuoteRetrieval SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (QuoteRetrievalSDK::test)
...
{
    private const SDK_CLASS = 'QuoteRetrievalSDK';
    ...
    private const SDK_BASE = 'quoteretrieval_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../quoteretrieval_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
