...
// QuoteRetrieval SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class QuoteRetrievalTransformResponse
{
    public static function call(QuoteRetrievalContext $ctx): mixed
    {
        ...
        $transform = QuoteRetrievalHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
