...
from core.utility_type import QuoteRetrievalUtility
...
class QuoteRetrievalSDK:
    ...
    def get_utility(self):
        return QuoteRetrievalUtility.copy(self._utility)
    ...
    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "QuoteRetrievalSDK":
        if sdkopts is None:
            sdkopts = {}
