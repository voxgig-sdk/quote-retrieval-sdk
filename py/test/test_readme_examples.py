# QuoteRetrieval SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions QuoteRetrievalSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both QuoteRetrievalSDK(...) and QuoteRetrievalSDK.test(...) become
#      QuoteRetrievalSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "quoteretrieval_sdk"
_SDK_CLASS = "QuoteRetrievalSDK"
