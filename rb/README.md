...
The Ruby SDK for the QuoteRetrieval API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
result, err = client.QuoteRetrieval(nil).load(
  { "id" => "test01" }, nil
)
