...
#      offline in seeded test mode (QuoteRetrievalSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "QuoteRetrieval_sdk.rb")
  SDK_CLASS = "QuoteRetrievalSDK"
