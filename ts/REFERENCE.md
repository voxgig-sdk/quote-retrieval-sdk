# QuoteRetrieval TypeScript SDK Reference

Complete API reference for the QuoteRetrieval TypeScript SDK.
...
```ts
new QuoteRetrievalSDK(options?: object)
```
...
#### `QuoteRetrievalSDK.test(testopts?, sdkopts?)`
...
**Returns:** `QuoteRetrievalSDK` instance in test mode.
...
Alias for `QuoteRetrievalSDK.test()`.
...
Return the parent `QuoteRetrievalSDK` instance.
